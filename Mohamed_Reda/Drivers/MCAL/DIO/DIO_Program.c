	...
	if( (u8Bit >= 0) && (u8Bit < 8) )
	{
		...
		if ( (0 == u8Status) || (1 == u8Status) )
		{
			...
			switch (u8Reg)
			{
				...
				case DIO_PORTA : {DIO_DDRA = SET_BIT_VALUE(DIO_DDRA,u8Bit,u8Status); return 0;} break;
				case DIO_PORTB : {DIO_DDRB = SET_BIT_VALUE(DIO_DDRB,u8Bit,u8Status); return 0;} break;
				case DIO_PORTC : {DIO_DDRC = SET_BIT_VALUE(DIO_DDRC,u8Bit,u8Status); return 0;} break;
				case DIO_PORTD : {DIO_DDRD = SET_BIT_VALUE(DIO_DDRD,u8Bit,u8Status); return 0;} break;
				default         : return 1;   /*error Undefined Port*/
...
u8 DIO_u8WriteReg(u8 u8Reg,u8 u8Value)
{
	...
	switch (u8Reg)
	{
		...
		case DIO_PORTA : {DIO_PORTA = Local_u8RegValue; return 0;}  break;
		case DIO_PORTB : {DIO_PORTB = Local_u8RegValue; return 0;}  break;
		case DIO_PORTC : {DIO_PORTC = Local_u8RegValue; return 0;}  break;
		case DIO_PORTD : {DIO_PORTD = Local_u8RegValue; return 0;}  break;
		default         : return 1;   /*error Undefined Port*/
	...
	if( (u8Bit >= 0) && (u8Bit < 8) )
	{
		...
		if ((0 == u8Value) || (1 == u8Value))
		{
			...
			switch (u8Reg)
			{
				...
				case DIO_PORTA : {SET_BIT_VALUE(DIO_PORTA,u8Bit,u8Value); return 0;} break;
				case DIO_PORTB : {SET_BIT_VALUE(DIO_PORTB,u8Bit,u8Value); return 0;} break;
				case DIO_PORTC : {SET_BIT_VALUE(DIO_PORTC,u8Bit,u8Value); return 0;} break;
				case DIO_PORTD : {SET_BIT_VALUE(DIO_PORTD,u8Bit,u8Value); return 0;} break;
				default         : return 1; /*error Undefined Port*/
...
u8 DIO_u8ToggleReg(u8 u8Reg)
{
	...
	switch (u8Reg)
	{
		...
		case DIO_PORTA : {DIO_PORTA ^= 0xff; return 0;} break;
		case DIO_PORTB : {DIO_PORTB ^= 0xff; return 0;} break;
		case DIO_PORTC : {DIO_PORTC ^= 0xff; return 0;} break;
		case DIO_PORTD : {DIO_PORTD ^= 0xff; return 0;} break;
		default         : return 1;  /*error Undefined Port*/
...
u8 DIO_u8ToggleBit(u8 u8Reg,u8 u8Bit)
{
	...
	if( (u8Bit >= 0) && (u8Bit < 8) )
	{
		...
		switch (u8Reg)
		{
			...
			case DIO_PORTA : {TOGGLE_BIT(DIO_PORTA,u8Bit); return 0;} break;
			case DIO_PORTB : {TOGGLE_BIT(DIO_PORTB,u8Bit); return 0;} break;
			case DIO_PORTC : {TOGGLE_BIT(DIO_PORTC,u8Bit); return 0;} break;
			case DIO_PORTD : {TOGGLE_BIT(DIO_PORTD,u8Bit); return 0;} break;
			default         : return 1;  /*error Undefined Port*/
...
{	
	...
	{
		/*Read PINx reg value*/
		case DIO_PORTA : return DIO_PINA;  break;
		case DIO_PORTB : return DIO_PINB;  break;
		case DIO_PORTC : return DIO_PINC;  break;
		case DIO_PORTD : return DIO_PIND;  break;
...
u8 DIO_u8ReadBit(u8 u8Reg,u8 u8Bit)
{
	...
	if( (u8Bit >= 0) && (u8Bit < 8) )
	{
		...
		switch (u8Reg)
		{
			...
			case DIO_PORTA : return GET_BIT(DIO_PINA,u8Bit);  break;
			case DIO_PORTB : return GET_BIT(DIO_PINB,u8Bit);  break;
			case DIO_PORTC : return GET_BIT(DIO_PINC,u8Bit);  break;
			case DIO_PORTD : return GET_BIT(DIO_PIND,u8Bit);  break;
...
u8 DIO_u8ConfigPullupReg(u8 u8Reg,u8 u8PullUpResStatus)
{
	...
	switch (u8Reg)
	{
		...
		case DIO_PORTA : {DIO_PORTA = Local_u8PullUpResStatus; return 0;}  break;
		case DIO_PORTB : {DIO_PORTB = Local_u8PullUpResStatus; return 0;}  break;
		case DIO_PORTC : {DIO_PORTC = Local_u8PullUpResStatus; return 0;}  break;
		case DIO_PORTD : {DIO_PORTD = Local_u8PullUpResStatus; return 0;}  break;
		default         : return 1; /*error Undefined Port*/
	...
	if( (DIO_EN_PULL_UP_RES == u8PullUpResStatus) || (DIO_DIS_PULL_UP_RES == u8PullUpResStatus) )
	{
		...
		if( (u8Bit >= 0) && (u8Bit < 8) )
		{
			...
			switch (u8Reg)
			{
				...
				case DIO_PORTA : {SET_BIT_VALUE(DIO_PORTA,u8Bit,u8PullUpResStatus); return 0;} break;
				case DIO_PORTB : {SET_BIT_VALUE(DIO_PORTB,u8Bit,u8PullUpResStatus); return 0;} break;
				case DIO_PORTC : {SET_BIT_VALUE(DIO_PORTC,u8Bit,u8PullUpResStatus); return 0;} break;
				case DIO_PORTD : {SET_BIT_VALUE(DIO_PORTD,u8Bit,u8PullUpResStatus); return 0;} break;
				default         : return 1;  /*error Undefined Port*/
